...
public class Renderer {
	...
	/*
	 * public void registerMenuLayer(CanvasLayer menuLayer) { this.menuLayer =
	 * menuLayer; }
	 */
	...
	/*
	 * public void renderMenu() { menuLayer.getGraphicsContext2D().save();
	 * menuLayer.getDrawables().forEach(d ->
	 * d.drawToCanvas(menuLayer.getGraphicsContext2D()));
	 * menuLayer.getGraphicsContext2D().restore(); }
	 * 
	 * public void prepareMenu() { menuLayer.prepareLayer(); }
	 */
